...
MemoryAligned16.prototype.load32 = function (offset) {
  return (
    this.buffer[(offset >> 1) & ~1] | (this.buffer[(offset >> 1) | 1] << 16)
  );
};
...
GameBoyAdvancePalette.prototype.mix = function (
  aWeight,
  aColor,
  bWeight,
  bColor
...
GameBoyAdvanceOBJ.prototype.drawScanlineNormal = function (
  backing,
  y,
  yOff,
  start,
...
GameBoyAdvanceOBJ.prototype.drawScanlineAffine = function (
  backing,
  y,
  yOff,
  start,
...
GameBoyAdvanceOBJLayer.prototype.drawScanline = function (
  backing,
  layer,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer$1.prototype.clearSubsets = function (
  mmu,
  regions
) {
  if (regions & 0x04) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeDisplayControl = function (
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundControl = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundHOffset = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundVOffset = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundRefX = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundRefY = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundParamA = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundParamB = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundParamC = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.writeBackgroundParamD = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.setBlendEnabled = function (
  layer,
  enabled,
  override
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.accessMapMode0 = function (
  base,
  size,
  x,
  yBase,
...
GameBoyAdvanceSoftwareRenderer$1.prototype.accessMapMode1 = function (
  base,
  size,
  x,
  yBase,
...
GameBoyAdvanceSoftwareRenderer$1.pushPixel = function (
  layer,
  map,
  video,
  row,
...
GameBoyAdvanceSoftwareRenderer$1.prototype.drawScanlineBlank = function (
  backing
) {
...
GameBoyAdvanceSoftwareRenderer$1.prototype.drawScanlineBGMode0 = function (
  backing,
  bg,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer$1.prototype.drawScanlineBGMode2 = function (
  backing,
  bg,
  start,
  end
  ...
  for (x = start; x < end; ++x) {
    ...
    color = this.vram.loadU8(
      charBase + (map.tile << 6) + ((localY & 0x7) << 3) + (localX & 0x7)
    );
...
GameBoyAdvanceSoftwareRenderer$1.prototype.drawScanlineBGMode3 = function (
  backing,
  bg,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer$1.prototype.drawScanlineBGMode4 = function (
  backing,
  bg,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer$1.prototype.drawScanlineBGMode5 = function (
  backing,
  bg,
  start,
  end
