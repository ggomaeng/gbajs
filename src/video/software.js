...
GameBoyAdvanceSoftwareRenderer.prototype.clearSubsets = function (
  mmu,
  regions
) {
  if (regions & 0x04) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeDisplayControl = function (
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundControl = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundHOffset = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundRefX = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundRefY = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundParamA = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundParamB = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundParamC = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.writeBackgroundParamD = function (
  bg,
  value
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.setBlendEnabled = function (
  layer,
  enabled,
  override
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.accessMapMode0 = function (
  base,
  size,
  x,
  yBase,
...
GameBoyAdvanceSoftwareRenderer.prototype.accessMapMode1 = function (
  base,
  size,
  x,
  yBase,
...
GameBoyAdvanceSoftwareRenderer.pushPixel = function (
  layer,
  map,
  video,
  row,
...
GameBoyAdvanceSoftwareRenderer.prototype.drawScanlineBlank = function (
  backing
) {
...
GameBoyAdvanceSoftwareRenderer.prototype.drawScanlineBGMode0 = function (
  backing,
  bg,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer.prototype.drawScanlineBGMode2 = function (
  backing,
  bg,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer.prototype.drawScanlineBGMode3 = function (
  backing,
  bg,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer.prototype.drawScanlineBGMode4 = function (
  backing,
  bg,
  start,
  end
...
GameBoyAdvanceSoftwareRenderer.prototype.drawScanlineBGMode5 = function (
  backing,
  bg,
  start,
  end
